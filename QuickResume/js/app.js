...
let nameDsp = document.getElementById('fullname_dsp'),
    ...
    interestDsp = document.getElementById('interest_dsp');
...
const getUserInputs = () => {
    ...
    let languageElem = document.querySelectorAll('.lang_name')
    let interestElem = document.querySelectorAll('.interest_name')
    ...
    languageElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Language Name')));

    interestElem.forEach(item => item.addEventListener('keyup', (e) => validateFormData(e.target, validType.ANY, 'Interest Name')))
    ...
    return {
        ...
        languages: fetchValues(['lang_name'], languageElem),
        interest: fetchValues(['interest_name'], interestElem)
    }
};
...
const showListData = (listData, listContainer) => {
    ...
    listData.forEach(listItem => {
        ...
        itemElem.classList.add('temp-item');
        
        for(const key in listItem){
            let subItemElem = document.createElement('span');
            subItemElem.classList.add('temp-item-val');
...
const displayCV = (userData) => {
    ...
    showListData(userData.interest, interestDsp);
